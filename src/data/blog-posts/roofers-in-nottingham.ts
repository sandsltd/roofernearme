...
const nottinghamPost: BlogPost = {
  slug: 'roofers-in-nottingham',
  title: 'Find Trusted Roofers in Nottingham: A Complete Guide',
  excerpt: 'Discover how to find reliable roofing contractors in Nottingham, understand local building regulations, and get the best value for your roofing project.',
  content: `
    <div class="prose prose-lg max-w-none">
      <h2 class="text-3xl font-bold mb-6">Find Trusted Roofers in Nottingham: Your Complete Guide</h2>
      
      <div class="intro bg-blue-50 p-6 rounded-lg my-8">
        <h3 class="text-2xl font-semibold mb-4">Why Choose a Local Nottingham Roofer?</h3>
        <ul class="space-y-3">
          <li>🏠 Understanding of local architecture</li>
          <li>📋 Knowledge of Nottingham building regulations</li>
          <li>🌧️ Experience with East Midlands weather patterns</li>
      ...
      <div class="architecture bg-yellow-50 p-6 rounded-lg my-8">
        <h3 class="text-2xl font-semibold mb-4">Nottingham's Diverse Architecture</h3>
      ...
      <div class="services bg-green-50 p-6 rounded-lg my-8">
        <h3 class="text-2xl font-semibold mb-4">Common Roofing Services in Nottingham</h3>
        <div class="space-y-4">
          <div>
          ...
          <div>
            ...
            <ul class="list-disc pl-4">
              ...
              <li>University building repairs</li>
      ...
      <div class="areas-covered bg-purple-50 p-6 rounded-lg my-8">
        <h3 class="text-2xl font-semibold mb-4">Areas We Cover in Nottingham</h3>
      ...
      <div class="local-considerations bg-red-50 p-6 rounded-lg my-8">
        <h3 class="text-2xl font-semibold mb-4">Nottingham-Specific Considerations</h3>
        <ul class="space-y-3">
          <li><strong>Weather Impact:</strong> Solutions for East Midlands weather conditions</li>
          ...
          <li><strong>Local Regulations:</strong> Nottingham City Council building requirements</li>
        </ul>
      </div>

      <div class="choosing-roofer bg-gray-50 p-6 rounded-lg my-8">
        <h3 class="text-2xl font-semibold mb-4">How to Choose a Nottingham Roofer</h3>
        <ol class="space-y-3">
      ...
      <div class="pricing bg-blue-50 p-6 rounded-lg my-8">
        <h3 class="text-2xl font-semibold mb-4">Understanding Roofing Costs in Nottingham</h3>
        <ul class="space-y-3">
      ...
      <div class="cta-box bg-gray-50 p-8 rounded-lg my-8 text-center">
        <h3 class="text-2xl font-semibold mb-4">Need a Reliable Roofer in Nottingham?</h3>
  ...
  image: '/blog/roofers-in-nottingham.png',
  readTime: '8 min read',
  seoTitle: 'Find Trusted Roofers in Nottingham | Local Roofing Experts',
  seoDescription: 'Connect with verified local roofers in Nottingham. Expert roofing services for all property types, from Victorian houses to modern buildings.',
  keywords: ['Nottingham roofers', 'local roofers Nottingham', 'roofing contractors Nottingham', 'emergency roofers Nottingham', 'commercial roofers Nottingham', 'Nottingham roofing services']
};

export default nottinghamPost; 