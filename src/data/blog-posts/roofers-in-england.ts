...
const englandPost: BlogPost = {
  slug: 'roofers-in-england',
  title: 'Roofers in England: Complete National Guide (2024)',
  excerpt: 'Looking for trusted roofers in England? Our comprehensive national guide helps you find reliable roofing contractors across the country, with expert advice for every region.',
  content: `
    <div class="prose prose-lg max-w-none">
      <script type="application/ld+json">
      {
        ...
        {
          "@type": "Question",
          "name": "Do I need planning permission for roof work in England?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Most repairs and maintenance don&apos;t require planning permission, but significant alterations or work on listed buildings may need approval from your local authority."
          }
        },
        {
          "@type": "Question",
      ...
      <script type="application/ld+json">
      {
        "@context": "https://schema.org",
        "@type": "Article",
        "name": "Roofers in England",
        "description": "Comprehensive guide to finding and hiring reliable roofers across England, including regional considerations and expert advice.",
        "areaServed": {
          "@type": "Country",
          "name": "England"
        },
  ...
  readTime: '8 min read',
  seoTitle: 'Find Trusted Roofers in England | Complete National Guide (2024)',
  seoDescription: 'Looking for reliable roofers in England? Our comprehensive guide helps you find trusted local roofing contractors across the country. Free quotes & expert advice ☎️',
  keywords: [
    'Roofers in England',
    'English roofers',
    'roofing contractors England',
    'local roofers England',
    'emergency roofers England',
    'heritage roofers England',
    'commercial roofers England',
    'residential roofers England',
    'roof repairs England',
    'roof replacement England',
    'traditional roofing England',
    'modern roofing England',
    'slate roofing England',
    'tile roofing England',
    'flat roofing England',
    'London roofers',
    'Manchester roofers',
    'Birmingham roofers',
    'Liverpool roofers',
    'Leeds roofers',
    'best roofers England',
    'trusted roofers England',
    'qualified roofers England',
    'experienced roofers England',
    'local roofing companies England'
  ]
};

export default englandPost; 