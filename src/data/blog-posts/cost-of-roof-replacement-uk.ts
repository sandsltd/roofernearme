...
const post: BlogPost = {
  ...
  readTime: '8 min read',
  seoTitle: 'UK Roof Replacement Costs 2024 | Comprehensive Price Guide',
  seoDescription: 'Learn about the costs of roof replacement in the UK, including material costs, labour charges, and regional price variations. Updated for 2024.',
  keywords: ['roof replacement cost', 'new roof price', 'UK roofing costs', 'roof installation price', 'roofing materials cost'],
  content: `
